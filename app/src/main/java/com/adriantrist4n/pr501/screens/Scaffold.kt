...
import com.adriantrist4n.pr501.navigations.AppNavigation
import com.adriantrist4n.pr501.navigations.AppScreens
import com.adriantrist4n.pr501.ui.theme.ColorScaffold
import com.adriantrist4n.pr501.ui.theme.TitleScaffold
...
fun TopBarContent() {
    TopAppBar(
        ...
        title = { Text(text = "PR501", color = TitleScaffold, fontWeight = FontWeight.Bold) },
...
fun BottomNavigationContent(navController: NavController) {
    ...
    val items = listOf(AppScreens.Calcular)
